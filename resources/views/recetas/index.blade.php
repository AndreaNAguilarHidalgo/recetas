                ...
                @foreach ($recetas as $receta)
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ route('recetas.edit', ['receta' => $receta->id]) }}" class="btn btn-dark d-block mb-2 w-100">Editar</a>
                            <a href="{{ route('recetas.show', ['receta' => $receta->id]) }}" class="btn btn-success d-block mb-2 w-100">Ver</a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
